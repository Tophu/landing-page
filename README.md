    ...
    <div class="container">
      <div class="row">
        <div class="col-xs-12 col-sm-6 col-md-3">
            <div class="card">
              <img src="images/user.svg" alt="picture description" width="50">
              <h2>Fast</h2>
        ...
        <div class="col-xs-12 col-sm-6 col-md-3">
          <div class="card">
            <img src="images/diamond.svg" alt="picture description" width="50">
            <h2>Simple</h2>
        ...
        <div class="col-xs-12 col-sm-6 col-md-3">
          <div class="card">
            <img src="images/heart.svg" alt="picture description" width="50">
            <h2>Awesome</h2>
        ...
        <div class="col-xs-12 col-sm-6 col-md-3">
          <div class="card">
           <img src="images/phone.svg" alt="picture description" width="50">
           <h2>Beautiful</h2>
